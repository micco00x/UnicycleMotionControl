...
squared_trajectory_t0 = 0.0;
squared_trajectory_square_frame = [1.0; 0.5; 0.0];
squared_trajectory_desired_driving_velocity = 1.0;
squared_trajectory_square_length = 5.0;
...
desired_trajectory = squared_trajectory; % circular_trajectory, eight_shaped_trajectory, squared_trajectory
